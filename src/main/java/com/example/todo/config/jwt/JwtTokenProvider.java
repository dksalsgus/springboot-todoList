...
public class JwtTokenProvider {
    ...
    public String createToken(String userPk, List<String> roles) {
        ...
        return Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS256, secretKey) // 서명에 들어갈 암호화 알고리즘 및 시크릿값
                .compact();
    }

    // JWT 토큰에서 인증 정보 조회
    public Authentication getAuthentication(String token) {
        UserDetails userDetails = userPrincipalService.loadUserByUsername(this.getUserPk(token));
    ...
    // Request의 Header에서 token갑승ㄹ 가져온다 "X-AUTH-TOKEN":"토큰값"
